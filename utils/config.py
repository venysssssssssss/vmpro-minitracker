...
class Config:
    ...
    CACHE_TTL_STOCKS = int(os.getenv('CACHE_TTL_STOCKS', 300))  # 5 minutos
    CACHE_TTL_CRYPTO = int(os.getenv('CACHE_TTL_CRYPTO', 180))  # 3 minutos
