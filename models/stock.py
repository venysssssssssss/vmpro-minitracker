...
class Stock:
    ...
    def __post_init__(self):
        ...
        if self.change_percent is None and self.previous_close > 0:
            self.change_percent = ((self.price - self.previous_close) / self.previous_close) * 100
...
class Crypto:
    ...
    def __post_init__(self):
        ...
        if self.change_percent_24h is None and self.previous_close > 0:
            self.change_percent_24h = ((self.price - self.previous_close) / self.previous_close) * 100
