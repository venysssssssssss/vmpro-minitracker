...
from interfaces.data_provider import DataProvider, CryptoDataProvider
from models.stock import Stock, Crypto

class TrackerService:
    """Serviço principal para tracking de ações e criptos - Princípio da Responsabilidade Única"""
    
    def __init__(self, stock_provider: DataProvider, crypto_provider: CryptoDataProvider):
...
class PortfolioService:
    ...
    def add_stock_to_portfolio(self, symbol: str, quantity: float, purchase_price: float):
    ...
    def add_crypto_to_portfolio(self, symbol: str, quantity: float, purchase_price: float):
    ...
    def get_portfolio_summary(self) -> Dict:
        ...
        if self.crypto_portfolio:
            ...
            current_cryptos = self.tracker_service.get_multiple_cryptos(symbols)
